    ...
    grunt.initConfig({
        ...
        copy: {
            main: {
                files: [{
                    expand: true,
                    flatten: true,
                    src: ['src/gerbil.js', 'src/gerbil-dc.js', 'src/en.js', 'src/en-dc.js'],
                    dest: 'dist'
                }, {
                    expand: true,
                    flatten: true,
                    src: ['src/gerbil.js', 'src/gerbil-dc.js'],
                    dest: 'enbritely/js'
                }, {
                    expand: true,
                    flatten: true,
        ...
        compress: {
            main: {
                ...
                ext: '.js.gz',
                cwd: '.',
                src: ['dist/en.js', 'dist/gerbil.js', 'src/gerbil-dc.js', 'dist/en-dc.js']
            }
        },
        jsbeautifier: {

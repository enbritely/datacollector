(function(w) {
    ...
    var params = util.getQueryParams(GERBIL_URL);
    ...
    if (enviroment.wsid === undefined) {
        // console.log('No WSID. Aborting.');
        return false;
    }
    else {
        if (location.protocol === "https:") {
            LOGGER_URL = "https://dc-"+enviroment.wsid+".enbrite.ly";
        }
        else {
            LOGGER_URL = "http://dc-"+enviroment.wsid+".enbrite.ly";
        }
        LOGGER_URL = enviroment.collector || decodeURIComponent(params.collector) || LOGGER_URL;
    ...
    var xurl = function(obj) {
        ...
        // obj.ih = -1;
        // console.log(obj);
        return LOGGER_URL + '?wsid=' + obj.wsid + '&data=' + Base64.encode(JSON.stringify(obj))+'&ts=' + ts;
    };

...
var fns = (function(){
    ...
    return {
		...
		ds:			 function(event, node){ return ds_current; },
		dt:			 function(event, node){ return dt_current; },
        ...
        title:       function(event, node){ return $(document).attr("title"); },
		...
		dh:         function(event, node){ return $(document).height(); },
